...
const Section2 = () => {
  return (
    <div className="grid max-md:grid-cols-1 md:grid-cols-3 gap-8 bg-white px-8 py-10 w-full md:h-[280px] max-md:h-max">
      <div className={style.card}>
        ...
        <div className="w-full h-full flex justify-center items-center text-center text-[black] font-[300] text-[0.8em]">
          <p>
