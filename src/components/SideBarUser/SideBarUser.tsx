...
const SideBarUser = ({ onClick, selectedItem }: SidebarProps) => {
  ...
  return (
    <div
      ...
      } h-full bg-white flex flex-col transition-all duration-300 ease-in-out shadow-sm border-r border-gray-100`}
    >
          ...
          <nav className="space-y-1">
            {studyItems.map((item) => (
              <button
                ...
                } py-2.5 text-sm font-medium rounded-lg transition-all duration-200 group ${
      ...
      <div className="p-4 border-t border-gray-100">
        <button
          ...
          className={`w-full flex items-center ${
            isExpanded ? "justify-start px-3" : "justify-center px-0"
          } py-2.5 text-sm font-medium rounded-lg transition-all duration-200 group hover:bg-gray-50`}
        >
