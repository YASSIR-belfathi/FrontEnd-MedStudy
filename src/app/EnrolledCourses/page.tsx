    ...
    <div className="flex flex-row w-full h-full  ">
      <div className="aaaallll">
        <div className="search-section bg-white p-6 rounded-2xl m-2">
          ...
          <div className="courses-states  w-full h-max">
            <ul className="w-full h-max flex gap-4 mt-2">
              <li className=" w-max py-[2px] px-4 cursor-pointer h-fit bg-blue-100/5 border border-blue-300 rounded-2xl text-blue-600 text-sm">
                All Courses
              </li>
              <li className="w-max py-[2px] px-4 cursor-pointer h-fit bg-gray-50/70 p-3 border border-gray-200 rounded-2xl text-gray-500 text-sm">
                In Progress
              </li>
              <li className="w-max py-[2px] px-4 cursor-pointer h-fi bg-gray-50/70 p-3 border border-gray-200 rounded-2xl text-gray-500 text-sm">
                Completed
              </li>
              <li className="w-max py-[2px] px-4 cursor-pointer h-fi bg-gray-50/70 p-3 border border-gray-200 rounded-2xl text-gray-500 text-sm">
                Core Subjects
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden max-w-md">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 text-sm mb-6">
                ...
                diagnostic approaches, treatment protocols, and patient
